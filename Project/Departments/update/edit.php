...
if(isset($_GET['edit_id'])){
 ...
 $sql = "SELECT * FROM Departments WHERE Phone=" .$_GET['edit_id'];
...
// 4th number pay yaha pay car_category ki jaga table name likho
 $update = "UPDATE Departments SET LName='$b', Email='$c'  , Department='$d' , Phone='$e' , cnic='$f' where FName='$a' ";
...
<input type="text" name="d" placeholder="Department Name" value="<?php echo $row['Department']; ?>"><br>
<input type="text"  name="e" placeholder="Mobile Number" value="<?php echo $row['Phone']; ?>"><br>
<input type="text"  name="f" placeholder="CNIC Number" value="<?php echo $row['cnic']; ?>"><br>
