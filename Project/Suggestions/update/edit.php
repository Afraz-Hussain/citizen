...
if(isset($_GET['edit_id'])){
 ...
 $sql = "SELECT * FROM Suggestions WHERE Phone=" .$_GET['edit_id'];
...
// 4th number pay yaha pay car_category ki jaga table name likho
 $update = "UPDATE Suggestions SET LName='$b', Email='$c'  , Suggestion='$d' , Phone='$e' where FName='$a' ";
...
<input type="text" name="d" placeholder="Enter your Suggestion" value="<?php echo $row['Suggestion']; ?>"><br>
