...
if(isset($_GET['edit_id'])){
 ...
 $sql = "SELECT * FROM Services WHERE Phone=" .$_GET['edit_id'];
...
// 4th number pay yaha pay car_category ki jaga table name likho
 $update = "UPDATE Services SET LName='$b', Email='$c'  , Service='$d' , Phone='$e' where FName='$a' ";
...
<input type="text" name="d" placeholder="Enter the Service" value="<?php echo $row['Service']; ?>"><br>
