...
if(isset($_GET['edit_id'])){
 ...
 $sql = "SELECT * FROM Complaints WHERE Phone=" .$_GET['edit_id'];
...
// 4th number pay yaha pay car_category ki jaga table name likho
 $update = "UPDATE Complaints SET LName='$b', Area='$c'  , Details='$d' , Phone='$e' where FName='$a' ";
...
<input type="text"  name="c" placeholder="Area" value="<?php echo $row['Area']; ?>"><br>
<input type="text" name="d" placeholder="Enter Details" value="<?php echo $row['Details']; ?>"><br>
